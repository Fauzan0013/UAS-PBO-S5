...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if (tfUsername.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Username Jangan sampai lupa di isi");
            tfUsername.requestFocus();
        }
        else if(tfPassword.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Passowrd Jangan Lupa Di isi Ya");
            tfPassword.requestFocus();
        }
        else if (tfUsername.getText().contains("FauzanTamvan")&& tfPassword.getText().contains("123456")){
